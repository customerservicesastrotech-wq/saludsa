...
| Área | Qué incluye |
|---|---|
| Inicio (asistente) | Conversación amplia que empieza con un saludo, con botones de respuesta rápida, voz e imágenes adjuntas (la IA las lee); **Agenda** por horas o momentos del día, de varios días, con recordatorios (sustituye a "Tu día"); conteo de días y récord de la Meta P, aviso de riesgo según tu historial |
...
| Samsung (nuevo en 2.8) | **Samsung Calendar**: lo que se agenda en Plan 20 (agenda, horarios fijos y cumpleaños) se copia al calendario de la tablet que elijas, y se actualiza o borra cuando cambia en Plan 20; los eventos propios de Samsung Calendar no se tocan. **Samsung Reloj**: «ponme una alarma a las 6:30» (o «despiértame a las 7 y media», «de lunes a viernes») crea la alarma de verdad en el reloj, sin abrirlo; la IA también puede hacerlo |
...
| Modo dormir (2.6, automático desde 2.8) | Viene activado: todas las noches a las **22:30** la tablet queda bloqueada **hasta que suena la alarma** del reloj (si no hay alarma, a la hora de respaldo). Pantalla oscura sobre cualquier app, salvo las llamadas entrantes y un botón que abre solo el marcador de emergencia: al salir del marcador vuelve a bloquearse al instante (antes dejaba la tablet libre 10 min). Sin salida con PIN por defecto (se puede activar). Todo se cambia en Escudo → Modo dormir |
...
www/                 App (lo que ve el usuario)
  ...
  samsung.js         Samsung Calendar (copia y sincroniza) y alarmas en Samsung Reloj
android/app/src/main/java/com/jeanc/plan20/
  ...
  DispositivoPlugin.java       Calendario del sistema (Samsung Calendar), alarmas del reloj y próxima alarma
...
### 1. Pruebas automáticas (322 pruebas)
...
- `pruebas_agenda.js`: 56 pruebas de la Agenda: los cinco motivos por los que no se guardaba lo que contabas, recordatorios, saludo inicial, respuestas rápidas, imágenes y modo dormir.
...
- `pruebas_samsung.js`: 33 pruebas de la conexión con Samsung: horas dichas de muchas formas, alarmas (una vez o por días, también desde la IA), copia a Samsung Calendar (con hora, todo el día, horarios que se repiten, cumpleaños anuales, cambios y borrados sin duplicar), permisos y el modo dormir automático al actualizar.
...
- Que lo agendado aparezca en Samsung Calendar y que «ponme una alarma» la cree en Samsung Reloj.
- Que el modo dormir se desbloquee justo cuando suena la alarma, y que al salir del marcador de emergencia vuelva a bloquearse.
